...
router.route("/eliminar-ingredientes/:id").get(AdministradorController.viewProductoIngredienteDelete);
router.route("/eliminar-ingredientes").post(AdministradorController.deleteProductoIngrediente);
